...
class AIEngine:
    ...
    def summarize_logs(self, chat_logs):
        ...
        prompt_text = (
            ...
            "1. 'site_manpower_machinery': قائمة غير مرتبة بتنسيق HTML (<ul><li>...</li></ul>) تتضمن القوى العاملة، المهندسين، والمعدات والآليات المذكورة. تجاهل أي محادثات لا تتعلق بالعمل (مثل التحيات الصباحية، النكات، أو الأحاديث الجانبية).\n"
            "2. 'site_activities': قائمة غير مرتبة بتنسيق HTML (<ul><li>...</li></ul>) تتضمن أنشطة الموقع العامة، تقدم العمل، وأي مشكلات تم الإبلاغ عنها. ركز فقط على المعلومات التقنية والعملية.\n"
            "ملاحظة هامة: يجب تجاهل الرسائل غير ذات الصلة تماماً وعدم تضمينها في الملخص. إذا لم تتوفر معلومات مفيدة، اترك القائمة فارغة أو اكتب 'لا تتوفر بيانات'.\n"
